...
makedocs(;
    modules = [DoseResponseMixtures],
    authors = "Alejandro Merchan <alejandromerchan@users.noreply.github.com>",
    repo = "https://github.com/alejandromerchan/DoseResponseMixtures.jl/blob/{commit}{path}#{line}",
    sitename = "DoseResponseMixtures.jl",
    format = Documenter.HTML(;
        canonical = "https://alejandromerchan.github.io/DoseResponseMixtures.jl",
    ),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/alejandromerchan/DoseResponseMixtures.jl")
